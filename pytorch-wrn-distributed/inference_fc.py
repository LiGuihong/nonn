...
if __name__ == "__main__":
    ...
    sub_model = net.WRN_fc( batch_size=args.batch_size, weights=param['params'], stats=param['stats'] )
    ...
    with torch.no_grad():
        nn_format.nn_server( model=sub_model, host=args.ip, port=args.port, i_shape=(1,256,8,8) )